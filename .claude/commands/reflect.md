...
5. **Read current CLAUDE.md to check for existing rules**:
   - Read `CLAUDE.md` to understand what rules already exist
...
Below are proposed additions to your `CLAUDE.md` file. **Review these carefully before adding them.**
...
10. **Automatically update CLAUDE.md**:
   ...
   **PRIORITY 2: Add new rules**
   - THEN, append the new proposed rules to `CLAUDE.md`
