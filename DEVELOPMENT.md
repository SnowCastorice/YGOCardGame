...
| 稀有度 | 英文名 | 价格 | 配色 |
|--------|--------|------|------|
| PSER | Prismatic Secret Rare（棱镜秘密闪） | 2000🪙 | #ff44cc（品红） |
| SER | Secret Rare（秘密闪） | 1500🪙 | #ff6fa8（玫瑰粉） |
| UTR | Ultimate Rare（终极闪） | 1000🪙 | #e8a030（琥珀橙金） |
| UR | Ultra Rare（极稀有） | 500🪙 | #f5c842（暖金） |
| SR | Super Rare（超稀有） | 200🪙 | #b464e0（紫罗兰） |
| R | Rare（稀有） | 50🪙 | #4a9eff（蓝色） |
| NR | Normal Rare（普通闪） | 20🪙 | #a8b4c8（银蓝灰） |
| N | Common（普通） | 10🪙 | #8e8e8e（暗灰） |

> 稀有度等级排序（高→低）：PSER > SER > UTR > UR > SR > R > NR > N
