...
FILENAME_PATTERN = re.compile(
    ...
    r"(twitter|ygojp|ygometa|official)_"  # 来源
...
def main():
    ...
    print(f"  来源优先级: twitter+photo > twitter+render > ygojp > official > ygometa")
    print()
    ...
    output = {
        ...
        "_来源优先级": "twitter_photo > twitter_render > ygojp > official > ygometa",
